...
/**
* Orientate the camera with the mouse moves
*
* @param xRel : relative deplacement of the move with the x axis
* @param yRel : relative deplacement of the move with the y axis
*/
...
*
* @param input : object with the user keyboard and mouse input
*/
...
/**
* Set the modelview matrix for the camera movements
*
...
/**
* Set the first oriantation of the camera
*
* @vec3 pointCible : the first point towards wich the camera looks
*/
